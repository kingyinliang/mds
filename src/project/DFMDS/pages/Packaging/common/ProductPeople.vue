        ...
        <mds-card title="人员统计" :name="'productPeople'">
            ...
            <el-table class="newTable" :data="currentFormDataGroup" :row-class-name="RowDelFlag" header-row-class-name="tableHead" border style="width: 100%; min-height: 90px;">
                ...
                <el-table-column prop="verify_man" min-width="125" :show-overflow-tooltip="true">
                    ...
                    <template slot-scope="scope">
                        <el-select v-model="scope.row.userType" filterable placeholder="请选择" size="small" :disabled="!(isRedact && status !== 'C' && status !== 'D' && status !== 'P')" clearable @change="selectDept(scope.row)">
                ...
                <el-table-column prop="verify_date" width="210" :show-overflow-tooltip="true">
                    ...
                    <template slot-scope="scope">
                        <el-date-picker v-model="scope.row.startDate" type="datetime" value-format="yyyy-MM-dd HH:mm" format="yyyy-MM-dd HH:mm" placeholder="请选择" size="small" :disabled="!(isRedact && status !== 'C' && status !== 'D' && status !== 'P')" style="width: 180px;" />
                    </template>
                </el-table-column>
                ...
                <el-table-column prop="verify_date" min-width="210" :show-overflow-tooltip="true">
                    ...
                    <template slot-scope="scope">
                        <el-date-picker v-model="scope.row.endDate" type="datetime" value-format="yyyy-MM-dd HH:mm" format="yyyy-MM-dd HH:mm" placeholder="请选择" size="small" :disabled="!(isRedact && status !== 'C' && status !== 'D' && status !== 'P')" style="width: 180px;" />
                    </template>
                </el-table-column>
