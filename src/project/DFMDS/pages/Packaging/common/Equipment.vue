                    ...
                    <el-table-column label="开始时间" min-width="200">
                        ...
                        <template slot-scope="scope">
                            <el-form-item :prop="'r'+scope.$index+'.startDate'" :rules="dataRules.startDate">
                                <el-date-picker v-model="scope.row.startDate" type="datetime" size="small" value-format="yyyy-MM-dd HH:mm" format="yyyy-MM-dd HH:mm" placeholder="选择时间" style="width: 170px;" :picker-options="pickerOptionsStart[0][scope.$index]" @change="changeEnd(scope.row,scope.$index,0)" />
                            </el-form-item>
                        </template>
                    </el-table-column>
