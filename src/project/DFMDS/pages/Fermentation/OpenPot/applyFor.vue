    ...
    <div class="header_main">
        ...
        >
            ...
            <template slot="operation_column" slot-scope="{ scope }">
                ...
                <el-button v-if="(scope.row.statusName === '待处理' || scope.row.statusName === '待审核') && isAuth('ferOpnRevocation')" class="ra_btn" type="text" round size="mini" style="margin-left: 0;" @click="withdraw(scope.row, true)">
                    撤回
                </el-button>
            </template>
        </query-table>
