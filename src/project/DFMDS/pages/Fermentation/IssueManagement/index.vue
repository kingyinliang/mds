        ...
        >
            <template slot="home">
                <mds-card title="发料列表" :pack-up="false">
                    <el-table class="newTable markStyle" :data="dataList" :row-class-name="rowDelFlag" header-row-class-name="tableHead" border style="width: 100%; min-height: 90px;">
                        ...
                        <el-table-column label="组件物料" prop="status" />
                        <el-table-column prop="status" width="160px">
