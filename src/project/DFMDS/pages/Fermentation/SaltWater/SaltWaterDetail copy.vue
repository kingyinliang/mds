<template>
    <div class="header_main">
        <el-card class="searchCard" style="margin-bottom: 5px;">
            <el-row :gutter="20">
                <el-col :span="21">
                    <el-form :model="formDeatil" inline label-suffix="：" label-width="80px" size="mini">
                        <el-form-item label="发酵罐/池" prop="aaaaaaaa">
                            <el-input v-model="formDeatil.aaaaaaaa" size="small" disabled style="width: 160px;" />
                        </el-form-item>
                        <el-form-item label="制曲订单" prop="aaaaaaaa">
                            <el-input v-model="formDeatil.aaaaaaaa" size="small" disabled style="width: 160px;" />
                        </el-form-item>
                        <el-form-item label="制曲物料" prop="aaaaaaaa">
                            <el-input v-model="formDeatil.aaaaaaaa" size="small" disabled style="width: 160px;" />
                        </el-form-item>
                        <el-form-item label="制曲数量" prop="aaaaaaaa">
                            <el-input v-model="formDeatil.aaaaaaaa" size="small" disabled style="width: 160px;" />
                        </el-form-item>
                        <el-form-item label="出曲日期" prop="aaaaaaaa">
                            <el-input v-model="formDeatil.aaaaaaaa" size="small" disabled style="width: 160px;" />
                        </el-form-item>
                        <el-form-item label="发酵物料" prop="aaaaaaaa">
                            <el-input v-model="formDeatil.aaaaaaaa" size="small" disabled style="width: 160px;" />
                        </el-form-item>
                        <el-form-item label="操作人员" prop="aaaaaaaa">
                            <el-input v-model="formDeatil.aaaaaaaa" size="small" disabled style="width: 160px;" />
                        </el-form-item>
                        <el-form-item label="操作时间" prop="aaaaaaaa">
                            <el-input v-model="formDeatil.aaaaaaaa" size="small" disabled style="width: 160px;" />
                        </el-form-item>
