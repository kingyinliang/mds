...
<template lang="pug">
    div.header_main
                ...
                el-col(:span="2" style="font-size: 14px; line-height: 32px;")
                    ...
                    div(style="width: 100%; margin-top: 10px; text-align: right;")
                        template(style="float: right; margin-left: 10px;")
                            el-button(v-if="isAuth('ferTsSdQuery')" type="primary" size="small" @click="getList()") 查询
        ...
        redact-box(v-if="!(formHeader.checkStatus === 'C' || formHeader.checkStatus === 'D' || formHeader.checkStatus === 'P' || formHeader.checkStatus ==='M')" :disabled="redactBoxDisable" :is-redact.sync='isRedact' redact-auth="ferTsSdSave" save-auth="ferTsSdSave" submit-auth="kjTimeSubmit" :urgent-submit="false" :submit-rules="submitRules" :saved-rules="savedRules" :saved-datas="savedDatas" :submit-datas="submitDatas")
</template>
