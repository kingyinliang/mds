            ...
            <template slot="tab-head0">
                <div class="tab__heads clearfix">
                    ...
                    <div style="float: right;">
                        ...
                        <span>抬头文本：</span>
                        <el-input v-model="headText" size="small" style="width: 190px; margin-right: 10px;" />
...
export default class ProInStore extends Vue {
    ...
    mounted() {
        ...
        if (window.location.href.indexOf('?') !== -1) {
            ...
            const paramsTemp = {
                ...
                gzStatus: this.$refs.queryTable.activeName,
                current: 1,
                size: 10,
                total: 0
            };
    ...
    writeOffs() {
        ...
        this.$confirm(`数据已经调用SAP接口已入库，反审后将冲销SAP数据，是否反审？`, '反审确认', {
            ...
            AUDIT_API.INWRITEOFFS_API(list)
                .then(({ data }) => {
