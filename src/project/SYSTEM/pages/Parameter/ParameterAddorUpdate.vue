<template>
    <el-dialog :title="isParasType ? '新增类型' : isAddParas ? '新增参数':'修改参数'" :close-on-click-modal="false" :visible.sync="isDialogShow">
        <div style="height: 330px; overflow: auto;">
            <el-form ref="dataForm" :model="dataForm" :rules="dataForm" label-width="125px">
                ...
                <el-form-item label="参数类型编码：">
                    ...
                    <el-input v-if="isParasType" v-model.trim="dataForm.dictType" placeholder="手动输入" />
                </el-form-item>
                <el-form-item label="参数类型名称：">
                    <span v-if="!isParasType">{{ dataForm.dictName }}</span>
                    <el-input v-if="isParasType" v-model.trim="dataForm.dictName" placeholder="手动输入" />
                </el-form-item>
                <el-form-item label="参数编码：">
                    <el-input v-model.trim="dataForm.dictCode" placeholder="手动输入" />
                </el-form-item>
                <el-form-item label="参数名称：">
                    <el-input v-model.trim="dataForm.dictValue" placeholder="手动输入" />
                </el-form-item>
            </el-form>
        </div>
