<template>
    <div :style="{ width: width }">
        ...
        <div v-show="flag" @click="visibilityChange($event)" style="cursor: pointer; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;" :style="{ width: width }">
            {{ value ? value : '点击修改备注' }}
        </div>
        <el-tooltip :placement="placement" :effect="effect" :manual="true" ref="toolTip" v-show="!flag">
            <div slot="content" style="width: 300px; display: flex; flex: 1; flex-direction: column; justify-content: space-between;">
                ...
                <div style="flex: 1; align-self: flex-end; margin-top: 10px;">
                    <el-button type="primary" size="small" style="color: #000; background-color: #fff; border-color: #d9d9d9;" @click="cancel">取消</el-button>
