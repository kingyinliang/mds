        ...
        <div class="totalContainer">
            <div class="totalContainer_box">
                <div class="totalContainer_dataItem">
                    <p class="totalContainer_dataItem_title">
                        制曲一车间数据
                    </p>
                    ...
                    <div id="NightingaleRose1" class="NightingaleRose" />
                    <div class="totalContainer_dataItem_tit clearfix">
                        <img src="@/assets/img/echartsTitleBgL.png" alt="">
                        <span>当年产量概览</span>
                        <img src="@/assets/img/echartsTitleBgR.png" alt="">
                    </div>
                    <div id="pillar1" class="pillar" />
                </div>
                <div class="totalContainer_center">
                    <div class="totalContainer_center_top">
                        <div class="totalContainer_center_top_imgBox">
                            <div class="totalContainer_center_top_imgBox_img smallBox" @click="rotateCircle(0, $event)">
                                <p>已使用</p>
                                <p>
                                    <span>{{ House.oneWorkShop[0] }}</span>间
                                </p>
                            ...
                            <div class="totalContainer_center_top_imgBox_img bigBox" @click="rotateCircle(1, $event)">
                                <p>已使用</p>
                                <p>
                                    <span>{{ House.oneWorkShop[0] + House.twoWorkShop[0] }}</span>间
                                </p>
                            ...
                            <div class="totalContainer_center_top_imgBox_img smallBox" @click="rotateCircle(2, $event)">
                                <p>已使用</p>
                                <p>
                                    <span>{{ House.twoWorkShop[0] }}</span>间
                                </p>
                    ...
                    <div class="totalContainer_center_bottom">
                        <p class="totalContainer_dataItem_title" style="line-height: 30px;">
                            产量分布情况
                        </p>
                ...
                <div class="totalContainer_dataItem">
                    ...
                    <div id="NightingaleRose2" class="NightingaleRose" />
                    <div class="totalContainer_dataItem_tit clearfix">
                        <img src="@/assets/img/echartsTitleBgL.png" alt="">
                        <span>当年产量概览</span>
                        <img src="@/assets/img/echartsTitleBgR.png" alt="">
                    </div>
                    <div id="pillar2" class="pillar" />
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        NightingaleRoseData(data) {
            const option = JSON.parse(JSON.stringify(radiuspie));
            const dataAxis = [];
            const seriesData = [];
            data.forEach(item => {
                seriesData.push({
        ...
        PillarData(data) {
            const option = JSON.parse(JSON.stringify(pillar));
            const dataAxis = [];
            const seriesData = [];
            data.forEach(item => {
        ...
        PieData2(data) {
            ...
            let twoWorkShop = 0;
            data.oneWorkShop.forEach(item => {
                oneWorkShop = oneWorkShop + Number((item.amount / 1000).toFixed(2));
            });
            data.twoWorkShop.forEach(item => {
                twoWorkShop = twoWorkShop + Number((item.amount / 1000).toFixed(2));
            });
        ...
        rotateCircle(index) {
            ...
            this.$('.totalContainer_center_top_imgBox_img')
                .eq(index)
                .animate({ left: 0 }, 200);
            if (index === 0) {
                this.$('.totalContainer_center_top_imgBox_img')
                    .eq(1)
                    .animate({ left: rightMove }, 200);
                this.$('.totalContainer_center_top_imgBox_img')
                    .eq(2)
                    .animate({ left: leftMove }, 200);
            } else if (index === 1) {
                this.$('.totalContainer_center_top_imgBox_img')
                    .eq(2)
                    .animate({ left: rightMove }, 200);
