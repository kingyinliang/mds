                ...
                <el-col>
                    <el-form :model="plantList" :inline="true" size="small" label-width="70px" class="multi_row">
                        ...
                        <el-form-item label="生产订单：">
                            <el-input v-model="plantList.orderNo" class="width158px" />
                        </el-form-item>
                        <el-form-item label="容器类型：">
                            <el-select v-model="plantList.type" class="width158px">
                                <el-option label="请选择" value="" />
                                <el-option label="豆粕计量仓" value="豆粕计量仓" />
                                <el-option label="麦粉计量仓" value="麦粉计量仓" />
                                <el-option label="盐水罐" value="盐水罐" />
                            </el-select>
                        </el-form-item>
                        ...
                        <el-form-item class="floatr">
                            ...
                            <el-button v-if="isAuth('report:kjmORwht:expectKjmMaterial')" type="primary" size="small" @click="ExportExcel(true)">
                                导出
                            </el-button>
                        </el-form-item>
                    </el-form>
...
export default {
    ...
    methods: {
        ...
        // 导出
        ExportExcel() {
            exportFile(`${REP_API.REPOUTMATERIALREQUEXPORT_API}`, '物料领用汇总报表', this);
        }
    }
};
</script>
