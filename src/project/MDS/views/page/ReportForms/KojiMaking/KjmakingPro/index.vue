                ...
                <el-row v-show="searched" style="margin-top: 5px;">
                    <div style="min-height: 320px;">
                        <el-table border headerRowClassName="tableHead" :data="dataList">
                            ...
                            <el-table-column label="工厂" :showOverflowTooltip="true" width="150">
                                <template slot-scope="scope">
                                    {{ scope.row.factoryName }}
                                </template>
                            </el-table-column>
                            <el-table-column label="车间" :showOverflowTooltip="true" width="110">
                                <template slot-scope="scope">
                            ...
                            <el-table-column label="曲房号" :showOverflowTooltip="true" width="100">
                                <template slot-scope="scope">
                                    {{ scope.row.houseStr }}
                                </template>
                            </el-table-column>
