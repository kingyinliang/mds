    ...
    <div class="header_main">
                ...
                <el-col>
                    <el-form :model="plantList" :inline="true" size="small" class="sole_row">
                        ...
                        <el-form-item class="floatr">
                            <el-button v-if="isAuth('report:kjmORwht:flourYieldList')" type="primary" size="small" @click="GetList">
                                查询
                            </el-button>
                            <el-button v-if="isAuth('report:kjmORwht:expectFlourYield')" type="primary" size="small" @click="ExportExcel(true)">
                                导出
                            </el-button>
                        </el-form-item>
                    </el-form>
        ...
        <el-card style="margin-top: 5px;">
            <el-table :data="dataList" border tooltip-effect="dark" header-row-class-name="tableHead" style="width: 100%; margin-bottom: 20px;">
                ...
                <el-table-column label="小麦领用量" prop="wheat" />
                <el-table-column label="麦粉" prop="flour" />
                <el-table-column label="出粉率" prop="flourYield" />
                <el-table-column label="损耗率" prop="lossYield" />
            </el-table>
            <el-row>
...
export default {
    ...
    methods: {
        ...
        // 导出
        ExportExcel() {
            exportFile(`${REP_API.REPOUTPUTFLOURYIELDEXPORT_API}`, '出粉率', this);
        }
    }
};
</script>
