    ...
    <div class="header_main">
        <el-card class="fry-wheat-report-forms">
            <el-form :inline="true" :model="plantList" size="small" label-width="70px" class="sole_row">
                ...
                <el-form-item class="floatr">
                    ...
                    <el-button v-if="isAuth('report:formh:exportpwList')" type="primary" size="small" @click="ExportExcel(true)">
                        导出
                    </el-button>
                </el-form-item>
            </el-form>
        ...
        <el-card style="margin-top: 5px;">
            <el-table :data="dataList" border tooltip-effect="dark" header-row-class-name="tableHead" style="width: 100%; margin-bottom: 20px;">
                ...
                <el-table-column label="小颗粒量" prop="granuleWeight" />
                <el-table-column label="出仁率" prop="sell" />
...
export default {
    ...
    methods: {
        ...
        // 导出
        ExportExcel() {
            exportFile(`${REP_API.REPPWFRYOUT_API}`, 'PW小麦报表', this);
        }
    }
};
</script>
