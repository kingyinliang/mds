<template>
    <div class="header_main">
        ...
        <el-table :data="tableData">
            <el-table-column v-for="item in column" v-if="!item.hide" :key="item.prop" :fixed="item.fixed" :prop="item.prop" :label="item.label" :width="item.width || ''" :formatter="item.formatter" :showOverflowTooltip="true">
                <el-table-column v-for="chind in item.child" v-if="item.child" :key="chind.prop" :prop="chind.prop" :label="chind.label" :formatter="chind.formatter" :showOverflowTooltip="chind.showOverFlowTooltip" :width="chind.width || ''" />
            </el-table-column>
        </el-table>
    </div>
</template>
