    ...
    methods: {
        ...
        ProHours(resolve) {
            if (this.$refs.readytimes.readyDate.isCause === '1') {
                this.$refs.readytimes.readyDate.dayDinner === null ? (this.$refs.readytimes.readyDate.dayDinner = this.$refs.readytimes.readyDate.dayDinner) : (this.$refs.readytimes.readyDate.dayDinner = String(this.$refs.readytimes.readyDate.dayDinner));
                this.$refs.readytimes.readyDate.midDinner === null ? (this.$refs.readytimes.readyDate.midDinner = this.$refs.readytimes.readyDate.midDinner) : (this.$refs.readytimes.readyDate.midDinner = String(this.$refs.readytimes.readyDate.midDinner));
                this.$refs.readytimes.readyDate.nightDinner == null ? (this.$refs.readytimes.readyDate.nightDinner = this.$refs.readytimes.readyDate.nightDinner) : (this.$refs.readytimes.readyDate.nightDinner = String(this.$refs.readytimes.readyDate.nightDinner));
            } else {
