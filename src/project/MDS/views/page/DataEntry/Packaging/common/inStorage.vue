    ...
    <div>
        ...
        <div v-if="order.factoryCode !== '6010'" class="a">
            <div v-if="order.properties && order.properties !== '二合一&礼盒产线'">
                <el-table v-if="order.properties && order.properties !== '二合一&礼盒产线'" ref="table1" headerRowClassName="tableHead" :data="InDate" :rowClassName="RowDelFlag" border tooltipEffect="dark" style="width: 100%; margin-bottom: 20px;">
                    ...
                    <el-table-column v-if="order.workShopName === '包装三车间'" label="自动码垛-包材库" width="140">
                        <template slot-scope="scope">
                    ...
                    <el-table-column v-if="order.workShopName === '包装三车间'" label="单位" width="60">
                        <template slot-scope="scope">
                    ...
                    <el-table-column v-if="order.workShopName === '包装三车间'" label="自动码垛-立体库" width="120">
                        <template slot-scope="scope">
                    ...
                    <el-table-column v-if="order.workShopName !== '包装三车间'" label="自动上架-立体库" width="140">
                        <template slot-scope="scope">
        ...
        <div v-if="order.properties !== '二合一&礼盒产线' && order.workShopName !== '包装三车间' && order.factoryCode !== '6010'">
            ...
            <el-table ref="table1" headerRowClassName="tableHead" :data="InVlist" border tooltipEffect="dark" style="width: 100%; margin-bottom: 20px;">
                ...
                <el-table-column prop="aiShelvesUnitName" label="单位" width="60" />
                <el-table-column prop="jwzAcount" label="机维组确认数" width="120" />
                <el-table-column prop="differentUnitName" label="单位" width="60" />
                <el-table-column prop="orgnDifferent" label="原差异数量" width="120" />
                <el-table-column prop="differentUnitName" label="单位" width="60" />
                <el-table-column prop="differentInfo" label="差异说明" width="120" />
