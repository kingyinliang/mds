        ...
        <el-row>
            <el-col :span="24">
                <el-card>
                    <!--录入-->
                    <div>
                        <template v-for="(item, index) in flourContainerList">
                            <el-row v-if="index % 4 === 0" :key="index" :gutter="36" style="margin-top: 5px;">
                                <el-col v-if="index < flourContainerList.length" :span="6">
                                    <div class="stock-box">
                                        <div class="stock-img" />
                                        <div class="stock-text">
                                            {{ flourContainerList[index].holderName }}
                                        </div>
                                        <div class="clearfix" />
                                ...
                                <el-col v-if="index + 1 < flourContainerList.length" :span="6">
                                    <div class="stock-box">
                                        <div class="stock-img" />
                                        <div class="stock-text">
                                            {{ flourContainerList[index + 1].holderName }}
                                        </div>
                                        <div class="clearfix" />
                                        <div v-if="isRedact && inStorageState != 'submit' && inStorageState != 'checked'" class="stock-button enabled" @click="addNewRecord(flourContainerList[index + 1].holderId, flourContainerList[index + 1].holderName)">
                                            入罐
                                        </div>
                                        <div v-else class="stock-button disabled">
                                            入罐
                                ...
                                <el-col v-if="index + 2 < flourContainerList.length" :span="6">
                                    <div class="stock-box">
                                        <div class="stock-img" />
                                        <div class="stock-text">
                                            {{ flourContainerList[index + 2].holderName }}
                                        </div>
                                        <div class="clearfix" />
                                        <div v-if="isRedact && inStorageState != 'submit' && inStorageState != 'checked'" class="stock-button enabled" @click="addNewRecord(flourContainerList[index + 2].holderId, flourContainerList[index + 2].holderName)">
                                            入罐
                                        </div>
                                        <div v-else class="stock-button disabled">
                                            入罐
                                ...
                                <el-col v-if="index + 3 < flourContainerList.length" :span="6">
                                    <div class="stock-box">
                                        <div class="stock-img" />
                                        <div class="stock-text">
                                            {{ flourContainerList[index + 3].holderName }}
                                        </div>
                                        <div class="clearfix" />
                                        <div v-if="isRedact && inStorageState != 'submit' && inStorageState != 'checked'" class="stock-button enabled" @click="addNewRecord(flourContainerList[index + 3].holderId, flourContainerList[index + 3].holderName)">
                                            入罐
                                        </div>
                                        <div v-else class="stock-button disabled">
                                            入罐
...
export default {
    ...
    methods: {
        ...
        changeWheatContainer(value) {
            const wheat = this.wheatContainerList.find(item => item.holderId === value);
            let holderNo = '';
            if (wheat) {
