            ...
            <el-form :model="params" size="small" :inline="true" label-position="right" label-width="70px" class="sole_row">
                ...
                <el-form-item label="类型：">
                    <el-select v-model="params.type" class="selectwpx" style="width: 140px;">
                        <el-option label="投料" value="投料" />
                        <el-option label="入罐" value="入罐" />
                    </el-select>
                </el-form-item>
                    ...
                    <div class="box-item-top">
                        <div class="box-item-title">
                            ...
                            <div
                                ...
                                :class="{
                                    diannopassBtn: item.outStatus === 'noPass',
                                }"
                            >
                                状态：{{ item.outStatus === 'noPass' ? '审核不通过' : item.outStatus === 'saved' ? '已保存' : item.outStatus === 'submit' ? '已提交' : item.outStatus === 'checked' ? '通过' : item.outStatus === '已同步' ? '未录入' : item.outStatus }}
                            </div>
                        </div>
                            ...
                            <div class="box-item-container-right">
                                ...
                                <div class="btn">
                                    <el-button
                                        ...
                                        size="mini"
                                        :class="{
                                            nopassBtn: item.outStatus === 'noPass',
                                        }"
                                        @click="goPage('出曲', item)"
                                    >
                                        数据录入
                                    </el-button>
                                </div>
