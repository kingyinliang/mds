<template>
    <div>
        ...
        <mds-card :title="'混合入曲控制'" :name="'hunhe'">
            ...
            <div>
                <el-input v-model="craftfrom.blendException" type="textarea" :disabled="!(isRedact && this.craftfrom.status !== 'submit' && this.craftfrom.status !== 'checked')" class="textarea" style="width: 100%; height: 40px;" />
            </div>
        </mds-card>
    </div>
</template>
