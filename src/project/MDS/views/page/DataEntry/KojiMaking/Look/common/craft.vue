    ...
    <div>
                ...
                <el-row style=" margin-bottom: 10px; line-height: 32px;">
                    ...
                    <el-col :span="15">
                        <el-radio-group v-model="tech.processType">
                            <el-radio label="自动" :disabled="!(isRedact && tech.status !== 'submit' && tech.status !== 'checked')">
                                自动
                            </el-radio>
                            <el-radio label="半自动" :disabled="!(isRedact && tech.status !== 'submit' && tech.status !== 'checked')">
                                半自动
                            </el-radio>
                            <el-radio label="手动" :disabled="!(isRedact && tech.status !== 'submit' && tech.status !== 'checked')">
                                手动
                            </el-radio>
                        </el-radio-group>
                    </el-col>
                    <el-col :span="4">
                        ...
                        <el-button type="primary" :disabled="!(isRedact && tech.status !== 'submit' && tech.status !== 'checked')" size="small" style="float: right; margin-right: 10px;" @click="addline">
                            + 新增
                        </el-button>
                    </el-col>
                </el-row>
        ...
        <el-card>
            <el-form :inline="true" :model="tech" size="small">
                ...
                <div class="excarBox">
                    <el-input v-model="tech.guardException" type="textarea" :disabled="!(isRedact && tech.status !== 'submit' && tech.status !== 'checked')" class="textarea" style="width: 100%; height: 40px;" />
                </div>
            </el-form>
        </el-card>
    </div>
...
export default {
    ...
    rops: ['isRedact', 'formHeader', 'submitStatus'],
    data() {
        return {
            statuss: 'saved',
            userList: [],
