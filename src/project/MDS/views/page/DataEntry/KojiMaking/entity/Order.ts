...
export class Order {
    ...
    constructor(orderId: string, orderNo: string, orderDate: string, orderStatus: string, materialCode: string, materialName: string, planOutput: number, outputUnit: string, remark: string, delFlag: string) {
        this._orderStatus = '';
