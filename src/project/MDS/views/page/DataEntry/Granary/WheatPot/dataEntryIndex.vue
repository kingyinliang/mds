                ...
                <div class="card-right" style="background: #487bff;">
                    ...
                    <div class="dataEntry-head-leftRight-message">
                        ...
                        <div class="dataEntry-head-leftRight-message__item">
                            ...
                            <p> <em class="iconfont factory-cunchurongliang" />罐体容量 </p>
                        </div>
                        <div class="dataEntry-head-leftRight-message__item">
                            ...
                            <p> <em class="iconfont factory-bianma" />物料 </p>
                        </div>
                        <div class="dataEntry-head-leftRight-message__item">
                            <p>{{ total }} KG</p>
...
import { GRANARY_API, INVENTORY_API } from '@/api/api';
@Component({
    components: {},
...
export default class Index extends Vue {
    ...
    // 历史库存信息
    getHistoryList() {
        Vue.prototype.$http(`${INVENTORY_API.GRA_INVENTORY_HISTORY_LIST_API}`, `POST`, {
