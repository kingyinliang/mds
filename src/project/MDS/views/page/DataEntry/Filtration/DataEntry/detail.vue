                        ...
                        <el-form :model="formHeader" :inline="true" size="small" labelWidth="70px" class="marbottom multi_row">
                            ...
                            <el-form-item label="生产品项：">
                                <el-tooltip class="item" effect="dark" :content="formHeader.materialCode + ' ' + formHeader.materialName" placement="top-start">
                                    <p class="input_bottom" style="font-size: 12px;">
                ...
                .then(function() {
                    if (str === 'saved') {
                        ...
                        Promise.all([aidSubmit])
                            .then(function() {
                                const net201 = new Promise((resolve, reject) => {
                                    that.$refs.craft.SubmitMaterial(str, resolve);
                                });
                                const net202 = new Promise((resolve, reject) => {
