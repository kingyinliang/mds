<template>
    <div>
        <div class="inStorage_card">
            ...
            <div style="flex: 1;">
                <el-table headerRowClassName="tableHead" :data="InStorageDate" border tooltipEffect="dark" :rowClassName="RowDelFlag" @row-dblclick="updateRow">
                    ...
                    <el-table-column label="日期" width="80" prop="created" :showOverflowTooltip="true" />
                    <el-table-column label="罐号" width="80" prop="holderName" :showOverflowTooltip="true" />
                    <el-table-column label="批次" width="80" prop="batch" :showOverflowTooltip="true" />
                    ...
                    <el-table-column label="满罐时间" width="90" prop="fullDate" :showOverflowTooltip="true" />
                    <el-table-column label="罐内库存" width="80" prop="holderRemaining" :showOverflowTooltip="true" />
                    <el-table-column label="备注" prop="remark" :showOverflowTooltip="true" />
                    <el-table-column label="操作时间" width="100" prop="changed" :showOverflowTooltip="true" />
                    <el-table-column label="操作人" width="80" prop="changer" :showOverflowTooltip="true" />
                    <el-table-column label="操作" width="70" :showOverflowTooltip="true">
                        <template slot-scope="scope">
        ...
        <el-dialog width="400px" title="入罐" class="ShinHoDialog" :closeOnClickModal="false" :visible.sync="visible">
            <el-form ref="dataForm" :model="dataForm" :rules="dataRule" labelWidth="110px" size="small" style="width: 300px; margin: auto;" @keyup.enter.native="addIn()" @submit.native.prevent>
                ...
                <el-form-item label="满罐时间：">
                    <el-date-picker v-model="dataForm.fullDate" type="datetime" :disabled="dialogDisabled" valueFormat="yyyy-MM-dd HH:mm:ss" format="yyyy-MM-dd HH:mm" placeholder="选择" style="width: 190px;" />
                </el-form-item>
