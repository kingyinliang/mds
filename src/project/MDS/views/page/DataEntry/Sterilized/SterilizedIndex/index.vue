        ...
        <el-card class="searchCard queryHead">
            <el-form :model="formHeader" :inline="true" size="small" label-width="70px" class="sole_row">
                <el-form-item label="生产工厂：">
                    <el-select v-model="formHeader.factory" placeholder="请选择" class="selectwpx" style="width: 180px;" clearable>
                        <el-option v-for="(item, index) in factory" :key="index" :label="item.deptName" :value="item.deptId" />
                    </el-select>
                </el-form-item>
                <el-form-item label="生产车间：">
                    <el-select v-model="formHeader.workShop" :disabled="workshop.length===0" class="selectwpx" style="width: 140px;" placeholder="请选择" clearable>
                ...
                <el-form-item label="生产订单：">
                    <el-input v-model="formHeader.orderNo" style="width: 150px;" placeholder="请输入" clearable />
                </el-form-item>
                <el-button v-if="isAuth('ste:order:list')" type="primary" size="small" class="floatr" @click="getResultData(true)">
                    查询
                </el-button>
            </el-form>
        </el-card>
