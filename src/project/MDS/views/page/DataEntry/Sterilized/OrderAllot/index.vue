<template>
    <div>
                    ...
                    <el-col>
                        <el-form :model="formHeader" :inline="true" size="small" labelWidth="70px" class="multi_row">
                            ...
                            <el-form-item label="生产日期：">
                                <el-date-picker v-model="formHeader.productDate" valueFormat="yyyy-MM-dd" format="yyyy-MM-dd" type="date" placeholder="请选择" style="width: 180px;" />
                            </el-form-item>
        ...
        <div class="main">
            ...
            <el-card>
                <el-table :data="dataList" :spanMethod="objectSpanMethod" border headerRowClassName="tableHead" style="margin-top: 10px;" @selection-change="handleSelectionChange">
                    >
                    <el-table-column type="selection" width="35" :selectable="CheckBoxInit" fixed="left" />
                    <el-table-column label="订单状态" width="100" prop="orderStatus" showOverflowTooltip>
                    ...
                    <el-table-column label="品项" :showOverflowTooltip="true" width="180">
                        <template slot-scope="scope">
                    ...
                    <el-table-column width="160" prop="productDate">
                        ...
                        <template slot-scope="scope">
                            <el-date-picker v-model="scope.row.productDate" valueFormat="yyyy-MM-dd" format="yyyy-MM-dd" :disabled="ReturnStatus(scope.row)" size="small" type="date" placeholder="请选择" style="width: 140px;" />
                        </template>
                    </el-table-column>
                    ...
                    <el-table-column label="备注" width="110" :showOverflowTooltip="true">
                        <template slot-scope="scope">
