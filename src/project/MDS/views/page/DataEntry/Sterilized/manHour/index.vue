                ...
                <el-col :span="6" style="font-size: 14px; line-height: 32px;">
                    ...
                    <div style="width: 100%; margin-top: 10px; text-align: right;">
                        <template style="float: right; margin-left: 10px;">
                            <el-button v-if="isAuth('ste:timeSheet:list')" type="primary" size="small" @click="GetTimeList">
                                查询
                            </el-button>
                        ...
                        <!-- <template v-if="isRedact && searchCard" style="float: right; margin-left: 10px;">
                            <el-button v-if="isAuth('ste:timeSheet:update')" type="primary" size="small" @click="savedOrSubmitForm('saved')">
                                保存
                            </el-button>
                            <el-button v-if="isAuth('ste:timeSheet:update')" type="primary" size="small" @click="SubmitForm">
                                提交
                            </el-button>
                        </template> -->
                    </div>
