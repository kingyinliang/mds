<template>
    <div>
        <mds-card title="生产入库">
            ...
            <el-table header-row-class-name="tableHead" class="newTable" :row-class-name="RowDelFlag" :data="InDataList" border tooltip-effect="dark">
                ...
                <el-table-column label="备注" :show-overflow-tooltip="true" prop="kjmWorkShopName" min-width="190">
                    <template slot-scope="scope">
