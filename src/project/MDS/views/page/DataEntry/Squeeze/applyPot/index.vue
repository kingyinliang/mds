                    ...
                    <el-row>
                        <el-col>
                            <div style="line-height: 40px;">
                                <i style="font-size: 22px; float: left;" class="iconfont factory-shouqicaidan" /><span style="font-size: 16px; font-weight: bold; margin-left: 12px;">申请列表</span>
                            </div>
                        </el-col>
                    </el-row>
                    <el-row>
        ...
        <div class="main" style="padding-top: 0;">
            <div class="tableCard">
                <el-card>
                    <el-row>
                        <div style="line-height: 40px;">
                            <i style="font-size: 22px; float: left;" class="iconfont factory-shouqicaidan" /><span style="font-size: 16px; font-weight: bold; margin-left: 12px;">开罐明细</span>
                        </div>
                    </el-row>
                    <el-row>
