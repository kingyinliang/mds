                ...
                <el-row>
                    <el-col>
                        <div style="line-height: 40px;">
                            <i style="font-size: 22px; float: left;" class="iconfont factory-shouqicaidan" /><span style="font-size: 16px; font-weight: bold; margin-left: 12px;">申请基本信息</span>
                        </div>
                    </el-col>
                </el-row>
                <el-row type="flex">
        ...
        <div class="main">
            <div class="tableCard">
                ...
                <el-card>
                    <el-row>
                        <div style="line-height: 40px;">
                            <i style="font-size: 22px; float: left;" class="iconfont factory-shouqicaidan" /><span style="font-size: 16px; font-weight: bold; margin-left: 12px;">申请反馈信息</span>
                        </div>
                    </el-row>
                    <el-row>
...
export default class Index extends Vue {
    ...
    changeOptions(flag: string) {
        if (flag === 'factory') {
            ...
            const item = this.materialList.find(ele => ele.materialCode === this.formHeader.materialCode);
            this.formHeader.materialName = item ? item.materialName : '';
            this.formHeader.halfType = '';
            this.formHeader.halfName = '';
            this.getHalfTypeList(this.formHeader.factory, this.formHeader.materialCode);
        } else if (flag === 'halfType') {
            const item = this.halfTypeList.find(ele => ele.halfType === this.formHeader.halfType);
