...
export default class Index extends Vue {
    ...
    startValidate() {
        if (this.startForm.potNo === '') {
            ...
            return false;
        } else if (this.startForm.startAmount.Toastring() === '') {
    ...
    endValidate() {
        if (this.endForm.endAmount.Toastring() === '') {
            Vue.prototype.$warningToast('结束数不能为空');
            return false;
        } else if (this.endForm.fullPot === '1' && (this.endForm.fullPotAmount.Toastring() === '' || this.endForm.fullPotAmount.Toastring() === '0')) {
    ...
    modifyValidate() {
        if (this.modifyForm.potNo === '') {
            ...
            Vue.prototype.$warningToast('物料不能为空');
            return false;
        } else if (this.modifyForm.startAmount.Toastring() === '') {
            Vue.prototype.$warningToast('起始数不能为空');
            return false;
        } else if (this.modifyForm.endAmount.Toastring() === '') {
            Vue.prototype.$warningToast('结束数不能为空');
            return false;
        } else if (this.modifyForm.fullPot === '1' && this.modifyForm.fullPotAmount.Toastring() === '') {
            Vue.prototype.$warningToast('满罐数量不能为空');
            return false;
