                ...
                <el-col>
                    <el-form :model="formHeader" :inline="true" size="small" label-width="70px" class="multi_row">
                        ...
                        <el-form-item label="生产日期：">
                            <el-date-picker v-model="formHeader.productDate" type="date" placeholder="选择日期" format="yyyy-MM-dd" value-format="yyyy-MM-dd" class="width180px" />
                        </el-form-item>
        ...
        methods: {
            ...
            savedOrSubmitForm(str) {
                ...
                new Promise((resolve, reject) => {
                    ...
                    // })
                    Promise.all([net1, excSaveNet, textSaveNet])
                        .then(() => {
