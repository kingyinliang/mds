<template>
    <div class="header_main">
        ...
        <el-card v-show="fastS" class="searchCard  newCard ferCard" style="margin-top: 5px; overflow: initial;">
            <h3 class="cardTit">
                <i class="iconfont factory-shujuzonglan" style="color: #666; margin-right: 10px;" />发酵情况总览
                            ...
                            <div style="overflow: hidden;">
                                <div class="topBox_boxItem_bar">
                                    <div
                                        ...
                                        :style="{
                                            background: `linear-gradient(to right,${item.startColor} 0%,${item.startColor} 10%,${item.startColor})`,
                                        }"
                                    />
                                </div>
                                <div style="float: left; line-height: 30px; width: 32px; text-align: center; font-size: 14px;">
                                    {{ item.middleText }}
                                </div>
                                <div class="topBox_boxItem_bar">
                                    <div
        ...
        <el-card v-show="fastS" class="searchCard  newCard ferCard" style="margin-top: 5px;">
            <h3 style="color: black; margin-bottom: 8px; line-height: 20px;">
                <i class="iconfont factory-liebiao" style="color: #666; margin-right: 10px;" />发酵罐列表
                ...
                <el-col v-for="(item, index) in dataList" :key="index" :span="4">
                    <el-card class="dataList_item">
                        ...
                        <div class="dataList_item_pot clearfix" style="position: relative;">
                            <img v-if="item.ferOrderNo.slice(0, 4) === RDorder" src="@/assets/img/RD.png" alt="" style="position: absolute; left: 10px; top: 10px;">
