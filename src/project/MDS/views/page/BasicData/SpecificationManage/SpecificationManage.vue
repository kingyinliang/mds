<template>
    <el-col>
            ...
            <el-card>
                <div class="clearfix">
                    <el-row style="float: right;">
                        <el-form :inline="true" :model="form" size="small" labelWidth="68px" class="topforms2" @keyup.enter.native="GetList(true)" @submit.native.prevent>
                            <el-form-item>
                                <el-input v-model="form.materialCode" placeholder="物料" suffixIcon="el-icon-search" />
                            </el-form-item>
                            <el-form-item>
                ...
                <el-row>
                    <el-table ref="table1" class="orderTable" border headerRowClassName="tableHead" :data="SpecificationList" tooltipEffect="dark" style="width: 100%; margin-bottom: 20px;" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column prop="brand" label="品牌" width="100" :showOverflowTooltip="true" />
                        <el-table-column prop="largeClassName" label="大类" width="100" :showOverflowTooltip="true" />
                        <el-table-column prop="boxSpec" width="80" label="箱规格" :showOverflowTooltip="true" />
                        <el-table-column prop="boxSpecUnitName" label="单位" width="80" :showOverflowTooltip="true" />
                        <el-table-column prop="productSpec" width="80" label="瓶规格" :showOverflowTooltip="true" />
                        <el-table-column prop="productSpecUnitName" label="单位" width="80" :showOverflowTooltip="true" />
                        <el-table-column prop="changer" label="维护人" width="150" :showOverflowTooltip="true" />
        ...
        <specification-add-or-update v-if="visible" ref="SpecificationAddOrUpdate" :SerchSapList="SerchSapList" @refreshDataList="GetList" />
        <el-dialog title="高级查询" :closeOnClickModal="false" :visible.sync="visible1">
            <div class="formdata">
                <el-form :model="form" size="small" labelWidth="110px" class="orderdialog" @keyup.enter.native="GetList(true)">
