<template>
    <el-dialog :title="SpecificationId ? '修改规格信息' : '新增规格'" :closeOnClickModal="false" :visible.sync="visible">
        <div>
            <el-form ref="dataForm" :model="dataForm" statusIcon :rules="dataRule" labelWidth="100px" size="small" @keyup.enter.native="dataFormSubmit()">
                ...
                <el-form-item label="物料：" prop="material">
                    <el-select v-if="!SpecificationId" v-model="dataForm.material" filterable placeholder="请选择" style="width: 100%;" @change="setBrand">
                        <el-option v-for="item in serchSapList" :key="item.sapCode + ' ' + item.itemName + ' ' + item.kondm" :label="item.sapCode + ' ' + item.itemName + ' ' + item.kondm" :value="item.sapCode + ' ' + item.itemName + ' ' + item.kondm" />
                    </el-select>
                ...
                <el-form-item label="大类：" prop="largeClass">
                    <el-select v-model="dataForm.largeClass" filterable placeholder="请选择" style="width: 100%;">
                        <el-option v-for="item in largeClass" :key="item.code" :label="item.value" :value="item.code" />
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="瓶规格：">
                    <el-input v-model="dataForm.productSpec" placeholder="手动输入" />
                </el-form-item>
                ...
                <el-form-item v-if="SpecificationId" label="维护人：">
