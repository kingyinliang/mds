    ...
    <el-dialog width="450px" class="ShinHoDialog" :title="id ? '修改类别' : '新增类别'" :closeOnClickModal="false" :visible.sync="visible" @close="closeDialog">
        <el-form ref="dataForm" :model="dataForm" :rules="dataRule" labelWidth="155px" size="small" @keyup.enter.native="dataFormSubmit()" @submit.native.prevent>
            ...
            <el-form-item label="半成品类别：" prop="halfType">
                <el-input v-model="dataForm.halfType" placeholder="请输入" />
            </el-form-item>
            <el-form-item label="订单天数：" prop="orderDays">
                <el-input v-model="dataForm.orderDays" placeholder="请输入" />
            </el-form-item>
            <el-form-item label="报工成熟天数：" prop="matureDays">
                <el-input v-model="dataForm.matureDays" placeholder="请输入" />
            </el-form-item>
            <el-form-item label="发酵成熟天数：" prop="fermentationMatureDays">
                <el-input v-model="dataForm.fermentationMatureDays" placeholder="请输入" />
            </el-form-item>
