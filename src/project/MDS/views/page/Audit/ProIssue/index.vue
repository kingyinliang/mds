        ...
        <el-col>
            ...
            <div class="main">
                <el-card class="tableCard">
                    ...
                    <el-form ref="pstngDate" :model="plantList" :rules="plantListRule" size="small" :inline="true" labelPosition="right" labelWidth="100px" class="topforms">
                        <el-form-item label="过账日期：" prop="pstngDate">
                            <el-date-picker v-model="plantList.pstngDate" type="date" placeholder="选择" valueFormat="yyyy-MM-dd" style="width: 160px;" />
                        </el-form-item>
                    ...
                    <el-table ref="table1" headerRowClassName="tableHead" :data="AuditList" border tooltipEffect="dark" style="width: 100%; margin-bottom: 20px;" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column label="生产物料" :showOverflowTooltip="true" width="200">
                            <template slot-scope="scope">
                        ...
                        <el-table-column prop="inAmount" label="入库数量" showOverflowTooltip width="100" />
                        <el-table-column prop="countOutputUnitName" label="单位" width="50" />
                        <el-table-column label="组件物料" :showOverflowTooltip="true" width="200">
                            <template slot-scope="scope">
                        ...
                        <el-table-column label="物料批次" :showOverflowTooltip="true" width="130">
                            <template slot-scope="scope">
                        ...
                        <el-table-column prop="potNoName" label="领用罐号" :showOverflowTooltip="true" width="100" />
                        <el-table-column prop="filterDate" label="过滤日期" :showOverflowTooltip="true" width="100" />
                        ...
                        <el-table-column prop="workShopRemark" label="车间备注" :showOverflowTooltip="true" width="80" />
                        ...
                        <el-table-column prop="interfaceReturn" label="接口回写" :showOverflowTooltip="true" width="150" />
                        <el-table-column prop="memo" label="审核意见" :showOverflowTooltip="true" width="150" />
                        <el-table-column prop="verifyMan" :showOverflowTooltip="true" label="审核人" />
                        ...
                        <el-table-column fixed="right" label="操作" width="120">
                            <template slot-scope="scope">
                                ...
                                <el-button
                                    v-if="scope.row.status === 'checked' && (scope.row.interfaceReturnStatus === '1' || scope.row.interfaceReturnStatus === null) && isAuth('verify:material:resetMaterial')"
                                    class="ra_btn"
                                    type="warning"
                                    round
                                    size="mini"
                                    @click="ResetD(scope.row)"
                                >
                                    反审
                                </el-button>
                            </template>
    ...
    methods: {
        ...
        redact(row) {
            if (!row.redact) {
                ...
                this.$http(`${AUDIT_API.AUDITISSUEUPDATE_API}`, 'POST', [row])
                    .then(({ data }) => {
