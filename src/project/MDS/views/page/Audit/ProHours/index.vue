        ...
        <el-col>
            ...
            <div class="main">
                <el-card class="tableCard">
                    ...
                    <el-form ref="postgDate" :model="plantList" :rules="plantListRule" size="small" :inline="true" labelPosition="right" labelWidth="100px" class="topforms">
                        <el-form-item label="记账日期：" prop="postgDate">
                            <el-date-picker v-model="plantList.postgDate" type="date" placeholder="选择" valueFormat="yyyy-MM-dd" style="width: 160px;" />
                        </el-form-item>
                    </el-form>
                    <el-table ref="table1" headerRowClassName="tableHead" :data="AuditList" border tooltipEffect="dark" style="width: 100%; margin-bottom: 20px;" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column label="生产物料" :showOverflowTooltip="true" width="360">
                            <template slot-scope="scope">
                        ...
                        <el-table-column label="执行开始的确认日期" width="148">
                            <template slot-scope="scope">
                                <el-date-picker v-if="scope.row.redact" v-model="scope.row.execStartDate" type="date" valueFormat="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="选择" size="small" />
                                <span v-else>{{ scope.row.execStartDate }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column label="设置完成的确认日期" width="148">
                            <template slot-scope="scope">
                                <el-date-picker v-if="scope.row.redact" v-model="scope.row.setupFinDate" type="date" valueFormat="yyyy-MM-dd" format="yyyy-MM-dd" placeholder="选择" size="small" />
                                <span v-else>{{ scope.row.setupFinDate }}</span>
                            </template>
                        </el-table-column>
                        <el-table-column label="操作活动编号" :showOverflowTooltip="true" width="105">
                            <template slot-scope="scope">
                        ...
                        <el-table-column label="部分/最后确认" :showOverflowTooltip="true" width="112">
                            <template slot-scope="scope">
            ...
            <el-dialog title="类型选择" :closeOnClickModal="false" :visible.sync="visibleSterilized">
