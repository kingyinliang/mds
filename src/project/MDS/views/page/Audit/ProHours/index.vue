        ...
        data() {
            return {
                ...
                plantList: {
                    ...
                    productDateEnd: '',
                    postgDate: new Date().getFullYear().Toastring() + '-' + (new Date().getMonth() + 1 >= 10 ? (new Date().getMonth() + 1).Toastring() : '0' + (new Date().getMonth() + 1)) + '-' + (new Date().getDate() >= 10 ? new Date().getDate().Toastring() : '0' + new Date().getDate()),
                    status: '',
                    currPage: 1,
                    pageSize: 10,
                    totalCount: 0
