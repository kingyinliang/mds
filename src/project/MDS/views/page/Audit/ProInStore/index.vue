                        ...
                        <el-col>
                            <el-form :model="plantList" size="small" :inline="true" labelPosition="right" labelWidth="70px" class="multi_row">
                                ...
                                <el-form-item label="生产日期：">
                                    <el-date-picker v-model="plantList.prodDate" type="date" placeholder="选择" valueFormat="yyyy-MM-dd" style="width: 160px;" />
                                </el-form-item>
            ...
            <div class="main">
                <el-card class="tableCard">
                    ...
                    <el-table ref="table1" headerRowClassName="tableHead" :data="AuditList" border tooltipEffect="dark" style="width: 100%; margin-bottom: 20px;" @selection-change="handleSelectionChange">
                        ...
                        <el-table-column :showOverflowTooltip="true" label="备注">
                            <template slot-scope="scope">
