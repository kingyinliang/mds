          ...
          <div class="dataList_item_pot clearfix" style="position: relative;">
            ...
            <div class="dataList_item_pot_box">
              <div class="dataList_item_pot_box1">
                ...
                <div class="dataList_item_pot_box_item2" v-if="item.holderAmout" :class="`${item.holderStatus === '4'? 'dataList_item_pot_box_item2s' : item.reWorkAmount? 'dataList_item_pot_box_item2' : 'dataList_item_pot_box_item2s'}`" :style="`height:${item.holderStatus === '4'? (item.sumAmout / item.holderAmout) * 100 : item.holderStatus === '3'? (item.sumAmout / item.holderAmout) * 100 : item.halfAmount? (item.halfAmount / item.holderAmout) * 100:(item.ferAmount / item.holderAmout) * 100}%`">
