          ...
          <el-row :gutter="20">
              ...
              <div class="card-item-color-lump" style="background: #ffbf00;">
                ...
                <div class="card-item-color-lump__img">
                  <div class="card-item-color-lump__img__box">
                    <div class="card-item-color-lump__img__box__bg" :style="{height: `${Math.min(sumBatch(item.pulpList) / (item.holderHold*1), 100)}%`}"></div>
                  </div>
            ...
            <el-col :span="12">
              <div class="card-item-color-lump">
                ...
                <p class="card-item-color-lump_text"><span>{{sumBatch(item.pulpList).toLocaleString()}}</span>KG</p>
      ...
      <div>
        <el-form :model="inParnForm" label-width="100px" size="small" ref="inParnForm">
          ...
          <el-form-item label="物料：">
            <template slot-scope="scope">
              <p class="disabled-text" style="width: 220px;">{{inParnForm.materialCode + ' ' + inParnForm.materialName}}</p>
            </template>
          </el-form-item>
          <el-form-item label="剩余数：" :disabled="true">
            <template slot-scope="scope">
              <p class="disabled-text" style="width: 220px;">{{inParnForm.currentQuantity}}</p>
            </template>
          </el-form-item>
          <el-form-item
            label="起始数："
          ...
          >
            <el-input  type='text' v-model.number="inParnForm.startWeight" style='width: 220px;' :disabled="isInputWeight" @change="countWeight('startWeight')">
              <i slot="suffix">KG</i>
            </el-input>
          </el-form-item>
          <el-form-item
          ...
          >
            <el-input  type='text' v-model.number="inParnForm.endWeight" style='width: 220px;' :disabled="isInputWeight" @change="countWeight('endWeight')">
              <i slot="suffix">KG</i>
            </el-input>
          </el-form-item>
          <el-form-item label="领用数量：">
            <template slot-scope="scope">
              <p class="disabled-text" style="width: 220px;">{{inParnForm.useWeight}} KG</p>
            </template>
          </el-form-item>
          <el-form-item label="操作时间：" >
            <p class="disabled-text" style="width: 220px;">{{inParnForm.changed}}</p>
          </el-form-item>
          <el-form-item label="操作人：">
            <p class="disabled-text" style="width: 220px;">{{inParnForm.changer}}</p>
          </el-form-item>
        </el-form>
      </div>
