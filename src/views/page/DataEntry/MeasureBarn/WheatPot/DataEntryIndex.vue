<template>
  <div class="header_main">
    ...
    <el-tabs ref='tabs'  v-model="activeName" id="DaatTtabs" class="NewDaatTtabs tabsPages" type="border-card" style="border-radius: 15px; overflow: hidden;">
      <el-tab-pane name="1">
    ...
    <el-dialog :visible.sync="isShowMessageBoxAdjust" width="900px" custom-class='dialog__class bg_dialog'>
